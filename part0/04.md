...
sequenceDiagram
      ...
      Note right of browser: server creates a new note object, and adds it to an array called notes, browser executes the callback function that renders the notes 
